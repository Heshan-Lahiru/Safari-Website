...
body {
      /* ... previous styles ... */
      display: grid; /* Create a grid layout for main content */
      grid-template-columns: 1fr 2fr; /* Divide into two columns */
    }

    #customer-info {
      grid-column: 1; /* Position the customer info in the first column (left) */
...
#robot-message {
  ...
  padding: 10px; /* Add padding to create space within the border */
}
...
body{
  background-image: url("img/pexels-felix-mittermeier-957024.jpg"); /* Replace with your image path */
  background-repeat: no-repeat;                    /* Prevent image repetition */
  background-size: cover;                          /* Stretch image to cover fieldset */
  padding: 20px; 
}
...
if (isset($_SESSION['cus_id'])) {
  require 'connect.php';
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<br><br<br><a class='beautiful-button' href='index.php'>Continue Safaris</a>";
        echo "</div>";
